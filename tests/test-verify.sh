...
if [ "${distribution}" = "debian" ] || [ "${distribution}" = "ubuntu" ]; then
    ...
    docker exec --tty ${container_id} env TERM=xterm ls /etc/postgresql/10/main
