# Ontic PostgreSQL ![Status](https://img.shields.io/badge/project-maintained-brightgreen.svg)

| Branch             | Build               | Galaxy              | Release              |
| :----------------- | :------------------ | :------------------ | :------------------- |
| **master**         | [![Build](https://img.shields.io/travis/ontic/ansible-role-postgresql/master.svg)](https://travis-ci.org/ontic/ansible-role-postgresql) | [![Galaxy](https://img.shields.io/badge/galaxy-ontic.postgresql-blue.svg)](https://galaxy.ansible.com/ontic/postgresql/) | [![Release](https://img.shields.io/github/release/ontic/ansible-role-postgresql.svg)](https://github.com/ontic/ansible-role-postgresql/releases) |

## Introduction

This role installs PostgreSQL on RedHat/CentOS and Debian/Ubuntu Linux servers.
...
```yml
- src: git+https://github.com/ontic/ansible-role-postgresql.git
  version: master
  name: ontic.postgresql
```
